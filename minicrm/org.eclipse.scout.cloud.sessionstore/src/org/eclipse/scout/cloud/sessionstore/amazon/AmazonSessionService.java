...
public class AmazonSessionService extends AbstractService implements ISessionStoreService {
  ...
  public void setAttribute(HttpServletRequest req, HttpServletResponse res, String key, Object value) {
    //LOG.info("[" + server + "] Session ID: " + req.getSession().getId());
    if (value != null) {
  ...
  public Object getAttribute(HttpServletRequest req, HttpServletResponse res, String key) {
    ...
    if (str != null) {
      ...
      LOG.info("Deserialisiert: " + obj.getClass());
      return obj;
    }
    else {
      return null;
